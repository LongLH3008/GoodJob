	...
	return (
		<>
			<div
				...
				hidden lg:block h-[550px] scale-[1.3] fixed transition-all duration-500 bg-[rgba(0,0,0,0.25)] rounded-tl-[75%] pt-20 pb-10 rounded-tr-[75%] w-full text-white`}
			></div>
			<div
				className={`
				${
				...
				hidden lg:block h-[550px] scale-125 fixed transition-all duration-700 bg-[rgba(0,0,0,0.55)] rounded-tl-[75%] pt-20 pb-10 rounded-tr-[75%] w-full text-white`}
			></div>
			<div
				className={`
